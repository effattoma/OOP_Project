...
public class SubGuide extends Person implements GuideInterface{
    ...
    @Override
    public void save_Guide(){
        SQLiteDBConnection con = new SQLiteDBConnection();
        Connection c = SQLiteDBConnection.connect();
        String sql = "Insert Into Guide (Name,NID,Phone,Age,Address,UserName,Password)Values(?,?,?,?,?,?,?);";
        try {
